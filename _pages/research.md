...
<li> <b>Trade Shocks in Distorted Economies: Evidence from Firm-level Import Data </b> <br>
 ...
 <summary style="cursor: pointer;"> <span class="cmu-serif;" style="font-size:small; font-weight: 600; cursor: pointer;"> Abstract <span class="abstract-state" style="cursor: pointer;">[+]</span></span> </summary>
...
<span style="font-size:small;"> (with <a href="https://economics.uchicago.edu/directory/sreyas-mahadevan">Sreyas Mahadevan</a>, and <a href="https://sites.google.com/site/davidperezreyna/">David Perez-Reyna</a>) </span> <br>
...
document.addEventListener("DOMContentLoaded", function() {
  document.querySelectorAll(".research-abstract").forEach(function(details) {
    var state = details.querySelector(".abstract-state");
    if (!state) {
      return;
    }
