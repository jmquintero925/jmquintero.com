...
<li> <b>Trade Shocks in Distorted Economies: Evidence from Firm-level Import Data </b> <br>
 ...
 <span style="font-size:1em;"> <a href="{{ 'files/pdf/drafts/AAHQ_draft_Jun2025.pdf' | relative_url }}">[Paper]</a> </span>
 <span style="font-size:1em;"> <a href="{{ 'files/pdf/slides/Slides_AFHQ.pdf' | relative_url }}"> [Slides]</a> (from <a href="https://ies.princeton.edu/events/princeton-ies-2025-summer-trade-workshop/">Princeton IES 2025</a>) </span> <br>
